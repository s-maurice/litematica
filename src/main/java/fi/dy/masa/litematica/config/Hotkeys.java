...
public class Hotkeys
{
    ...
    public static final ConfigHotkey EASY_PLACE_DEEP_TOGGLE             = new ConfigHotkey("easyPlaceDeepToggle",               "",    "Allows quickly toggling on/off the Easy Place Deep placement mode");
