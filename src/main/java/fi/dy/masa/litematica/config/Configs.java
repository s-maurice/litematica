...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigBoolean       DEEP_EASY_PLACE_MODE    = new ConfigBoolean(    "easyPlaceDeepMode", false, "Deep easy plaace tries to place the furthest block");
